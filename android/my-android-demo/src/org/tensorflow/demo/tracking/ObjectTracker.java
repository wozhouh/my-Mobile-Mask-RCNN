...
public class ObjectTracker {
  ...
  protected ObjectTracker(
    ...
    debugHistory = new Vector<>(MAX_DEBUG_HISTORY_SIZE);
  ...
  public class TrackedObject {
    ...
    synchronized RectF getTrackedPositionInPreviewFrame() {
      checkValidObject();
  ...
  synchronized TrackedObject trackObject(
